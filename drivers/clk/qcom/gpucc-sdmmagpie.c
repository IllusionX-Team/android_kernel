...
enum vdd_gx_levels {
	...
	VDD_GX_MIN,		/* MIN SVS */
	VDD_GX_LOWER,		/* SVS2 */
	VDD_GX_LOWER_L1,	/* SVS2L1 */
	VDD_GX_LOWER_L2,        /* SVS2L2 */
	VDD_GX_LOW,		/* SVS */
	VDD_GX_LOW_L0,		/* SVSL0 */
	VDD_GX_LOW_L1,		/* SVSL1 */
	VDD_GX_LOW_P,		/* SVSLP */
...
static int vdd_gx_corner[] = {
	...
	RPMH_REGULATOR_LEVEL_LOW_SVS_L1,	/* VDD_GX_LOWER_L1 */
	RPMH_REGULATOR_LEVEL_LOW_SVS_L2,        /* VDD_GX_LOWER_L2 */
	RPMH_REGULATOR_LEVEL_SVS,		/* VDD_GX_LOW */
	RPMH_REGULATOR_LEVEL_SVS_L0,		/* VDD_GX_LOW_L0 */
	RPMH_REGULATOR_LEVEL_SVS_L1,		/* VDD_GX_LOW_L1 */
	RPMH_REGULATOR_LEVEL_SVS_L1P,		/* VDD_GX_LOW_P */
	RPMH_REGULATOR_LEVEL_SVS_L2,		/* VDD_GX_LOW_L2 */
...
static struct clk_rcg2 gpu_cc_gx_gfx3d_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.rate_max = (unsigned long[VDD_GX_NUM]) {
			...
			[VDD_GX_LOWER_L1] = 565000000,
			[VDD_GX_LOW_P] = 650000000,
			[VDD_GX_LOW_L2] = 800000000,
